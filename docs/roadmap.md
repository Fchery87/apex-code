...
| Collapsed-by-default transcript | **landed** — a session opens at overview with thinking collapsed to one `Thinking... ctrl+o to expand` line; `ctrl+t` at overview opens to details · commit SHA recorded after merge · `npm test` green (3607 passed, 51 skipped) | [spec](specs/2026-09-25-collapsed-by-default-transcript.md) | — |
