...
| 6 | Durable state & daemon | **planned** — entry spec + plan written | [spec](specs/2026-08-15-durable-state-and-daemon.md) | [plan](plans/2026-08-15-durable-state-and-daemon.md) |
