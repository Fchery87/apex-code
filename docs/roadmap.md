...
| Collapsed-by-default transcript | **landed** — a session opens at overview with thinking collapsed to one `Thinking... ctrl+o to expand` line and multi-line errors folded to a summary; `ctrl+t` at overview opens to details · `afd8ac67a`, `0d7b2183a` · `npm test` green (3614 passed, 51 skipped) | [spec](specs/2026-09-25-collapsed-by-default-transcript.md) | — |
