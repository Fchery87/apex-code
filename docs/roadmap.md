...
| Transcript polish | **active** — tool disclosure through one counted hint, bash duration left to the header, one blank row per panel; message roles and retry collapse to follow | [spec](specs/2026-09-22-transcript-polish.md) | — |
