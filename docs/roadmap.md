...
| Trust classification and proof integrity | **draft** · the 2026-09-05 remediation shipped the untrusted-project guard without the classifier that decides a project is untrusted; four project-controlled resources are absent from `hasTrustRequiringProjectResources`, so a cloned repository is classified trusted and the guard is satisfied rather than triggered, reproduced at `2afe5a517` | [spec](specs/2026-09-11-trust-classification-and-proof-integrity.md) | — |
