...
| Git-backed session checkpoints | **in progress** — 8 of 8 tasks, one call site uncovered | [spec](specs/2026-08-28-git-checkpoints.md) | [plan](plans/2026-08-28-git-checkpoints.md) |
