...
| Git-backed session checkpoints | **in progress** — 7 of 7 tasks, one call site uncovered | [spec](specs/2026-08-28-git-checkpoints.md) | [plan](plans/2026-08-28-git-checkpoints.md) |
