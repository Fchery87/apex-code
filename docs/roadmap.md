...
| Chrome consistency | **active** — one hint-row grammar, one dock edge, sentence-case titles, spelled-out footer labels, and a one-line update notice | [spec](specs/2026-09-22-chrome-consistency.md) | — |
