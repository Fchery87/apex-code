...
| 6.2 Define additive SQLite schema and migrations | In progress | — | First schema slice is test-first and green: versioned sidecar, idempotent reopen, forward-version refusal, and explicit non-secret tables. Remaining work: adapter hardening and JSONL compatibility integration. |
