...
Before 1.0, **only the latest non-deprecated Apex Code release receives security support**
([ADR 0033](adr/0033-stable-release-line.md)). Older minor lines and the `0.0.x` versions
are not supported — upgrade before reporting an issue against one.
