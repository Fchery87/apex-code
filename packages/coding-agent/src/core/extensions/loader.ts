...
const VIRTUAL_MODULES: Record<string, unknown> = {
	...
	"apex-code-agent-core": _bundledPiAgentCore,
	...
	"apex-code": _bundledPiCodingAgent,
...
function getAliases(): Record<string, string> {
	...
	const piAgentCoreEntry = resolveWorkspaceOrImport("agent/dist/index.js", "apex-code-agent-core");
	...
	_aliases = {
		"apex-code": piCodingAgentEntry,
		"apex-code-agent-core": piAgentCoreEntry,
