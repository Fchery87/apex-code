...
const OFFICIAL_PACKAGE_NAME = "apex-code";
const OFFICIAL_APP_NAME = "apex-code";
const OFFICIAL_CONFIG_DIR_NAME = ".apex-code";
 ...
 * - experimental features are enabled (APEX_CODE_EXPERIMENTAL=1)
