...
export function getPackageDir(): string {
	...
	const envDir = getApexEnvironment("APEX_CODE_PACKAGE_DIR");
	if (envDir) {
...
export const PACKAGE_NAME: string = pkg.name || "apex-code";
export const APP_NAME: string = piConfigName || "apex-code";
export const APP_TITLE: string = piConfigName ? APP_NAME : "π";
export const CONFIG_DIR_NAME: string = pkg.piConfig?.configDir || ".apex-code";
export const VERSION: string = pkg.version || "0.0.0";

const ENV_PREFIX = APP_NAME.toUpperCase().replaceAll(/[^A-Z0-9]+/g, "_");
...
// =============================================================================
// User Config Paths (~/.apex-code/agent/*)
// =============================================================================

/** Get the agent config directory (e.g., ~/.apex-code/agent/) */
