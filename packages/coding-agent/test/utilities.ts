...
// ============================================================================
// OAuth API key resolution from ~/.apex-code/agent/auth.json
// ============================================================================

const AUTH_PATH = join(homedir(), ".apex-code", "agent", "auth.json");
...
/**
 * Resolve API key for a provider from ~/.apex-code/agent/auth.json
 *
...
/**
 * Check if a provider has credentials in ~/.apex-code/agent/auth.json
 */
...
export const PI_AGENT_DIR = join(homedir(), ".apex-code", "agent");

/**
 * Get an AuthStorage instance backed by ~/.apex-code/agent/auth.json
