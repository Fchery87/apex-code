...
<p align="center">
  ...
  <a href="https://www.npmjs.com/package/apex-code"><img alt="npm" src="https://img.shields.io/npm/v/apex-code?style=flat-square" /></a>
</p>
...
**Custom providers & models:** Add providers via `~/.apex-code/agent/models.json` if they speak a supported API (OpenAI, Anthropic, Google). For custom APIs or OAuth, use extensions. See [docs/models.md](docs/models.md) and [docs/custom-provider.md](docs/custom-provider.md).
...
- [apex-code-agent-core](https://www.npmjs.com/package/apex-code-agent-core): Agent framework
