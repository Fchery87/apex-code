...
| Keybinding id | Default | Description |
|--------|---------|-------------|
| `app.tools.expand` | `ctrl+o` | Cycle conversation detail: overview (the default, everything collapsed), details (diffs and thinking), all (full tool output) |
...
Create `~/.apex-code/agent/keybindings.json`:
