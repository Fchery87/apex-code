...
| `chatDetail` | string | unset | Transcript detail level a session opens at: `"overview"`, `"details"`, or `"all"`. Saved when you press `ctrl+o` or change it in `/settings`; unset opens at `"overview"` |
