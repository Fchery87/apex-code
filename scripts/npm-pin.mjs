...
export function describeNpmMismatch(pinned, actual) {
	...
	return (
		`This lockfile was generated by npm ${actual}, but this repository pins npm ${pinned}.\n` +
		"\n" +
		...
		"\n" +
		`Regenerate the lockfile on npm ${pinnedMajor}, for example:\n` +
		"  nvm use 22 && rm -rf node_modules && npm install\n" +
		"\n" +
